...
function addChineseUnit () {
  const addWan = function (integer: number, number:number, mutiple: number, decimalDigit: number) {
  ...
  return (number: number, decimalDigit: number) => {
...
export const chineseUnit = addChineseUnit()
